...
const PresentationLetter = dynamic(
  () => import("@app/_docs/internship/PresentationLetter"),
)
const CommitmentLetter = dynamic(() => import("@app/_docs/CommitmentLetter"))
const PDFWrapper = dynamic(() =>
  import("@app/_components/PDFWrapper").then((mod) => mod.PDFWrapper),
)
const PartialReportModal = dynamic(
  () => import("@app/estancias_profesionales/PartialReportModal"),
)
const FinalReportModal = dynamic(
  () => import("@app/estancias_profesionales/FinalReportModal"),
)
const FinalEvaluationModal = dynamic(
  () => import("@app/estancias_profesionales/FinalEvaluationModal"),
)
const DocumentReception = dynamic(
  () => import("@app/_docs/internship/DocumentReception"),
)
...
export const Documents = () => {
  ...
  const { target: intershipTarget, createPDF: createIntership } = usePDF(
    "Solicitud de Estancias Profesionales",
  )
  const { target: commitmentLetterTarget, createPDF: createCommitmentLetter } =
    usePDF("Carta Compromiso")
  const {
    target: documentReceptionTarget,
    createPDF: createDocumentReception,
  } = usePDF("Formato de Recpeción de Documentos")
  ...
  return (
    <>
      ...
      {isDataComplete && (
        <>
          {isOpen && (
            <PartialReportModal isOpen={isOpen} onOpenChange={onOpenChange} />
          )}
