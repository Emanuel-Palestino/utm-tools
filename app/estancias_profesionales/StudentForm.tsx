...
const StudentForm: FC<StudentFormProps> = ({ nextForm }) => {
  ...
  const { handleSubmit, control } = useForm<InternshipStudent>({
    defaultValues: {
        ...
        >
          <Controller
            ...
            render={({ field }) => (
              ...
              >
                <SelectItem
                  key={StudentState.ACTIVE}
                  value={StudentState.ACTIVE}
                >
                  Activo
                </SelectItem>
                <SelectItem
                  key={StudentState.GRADUATED}
                  value={StudentState.GRADUATED}
                >
                  Egresado
                </SelectItem>
                <SelectItem
                  key={StudentState.TEMPORARY_LEAVE}
                  value={StudentState.TEMPORARY_LEAVE}
                >
                  Baja Temporal
                </SelectItem>
              </Select>
          ...
          <Controller
            ...
            control={control}
            render={({ field }) => (
              <Input type="text" label="Grupo" isRequired {...field} />
            )}
          />
          ...
          <Controller
            ...
            render={({ field }) => (
              <Switch {...field} value="" isSelected={field.value}>
                ¿Tienes que presentar primer exámen extraordinario?
              </Switch>
            )}
          />
          ...
          <Controller
            ...
            render={({ field }) => (
              <Switch {...field} value="" isSelected={field.value}>
                ¿Tienes que presentar segundo exámen extraordinario?
              </Switch>
            )}
          />
