...
const Registration = dynamic(() =>
  import("@app/_docs/social_service/Registration").then(
    (mod) => mod.Registration,
  ),
)
const DocumentReception = dynamic(() =>
  import("@app/_docs/social_service/DocumentReception").then(
    (mod) => mod.DocumentReception,
  ),
)
const ScheduleOfActivities = dynamic(() =>
  import("@app/_docs/social_service/ScheduleOfActivities").then(
    (mod) => mod.ScheduleOfActivities,
  ),
)
...
const PartialReportModal = dynamic(
  () => import("@app/servicio_social/PartialReportModal"),
)
const FinalEvaluationModal = dynamic(
  () => import("@app/servicio_social/FinalEvaluationModal"),
)
...
export const Documents = () => {
  ...
  /* PDF documents */
  const { target: registration, createPDF: createRegistration } = usePDF(
    "Registro de Servicio Social",
  )
  const {
    target: scheduleOfActivities,
    createPDF: createScheduleOfActivities,
  } = usePDF("Cronograma de Actividades", true)
  const { target: documentReception, createPDF: createDocumentReception } =
    usePDF("Formato de Recepción de Documentos")
