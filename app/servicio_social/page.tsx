...
export const metadata: Metadata = {
  ...
  description:
    "Documentación para solicitud y seguimiento de servicio social en la Universidad Tecnológica de la Mixteca: procesos, requisitos, formatos, plantillas y documentos.",
  keywords: [
  ...
  return (
    <div className="container mx-auto py-5 px-3">
      <h1 className="text-center text-xl sm:text-3xl font-semibold mb-8 mt-1">
        Documentación para realizar el Servicio Social de la UTM
      </h1>
      ...
      <div className="w-full flex flex-col gap-12">
        ...
        <section>
          <h2 className="text-xl sm:text-2xl text-center md:text-left mb-4">
