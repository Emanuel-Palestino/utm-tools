...
const PersonForm = dynamic(() => import("@app/servicio_social/PersonForm"), {
  loading: () => <SkeletonForm rows={5} />,
})
const StudentForm = dynamic(() => import("@app/servicio_social/StudentForm"), {
  loading: () => <SkeletonForm rows={4} />,
})
const GovernmentAgencyForm = dynamic(
  () => import("@app/servicio_social/GovernmentAgencyForm"),
  { loading: () => <SkeletonForm rows={6} /> },
)
const PeriodForm = dynamic(() => import("@app/servicio_social/PeriodForm"), {
  loading: () => <SkeletonForm rows={5} />,
})
const ActivitiesForm = dynamic(
  () => import("@app/servicio_social/ActivitiesForm"),
  { loading: () => <SkeletonForm rows={5} /> },
)
...
export const Form = () => {
  ...
  return (
    <Tabs
      ...
      classNames={{
        base: "w-full",
        tabList: "w-full flex flex-col lg:flex-row",
      }}
      size="lg"
    >
      <Tab
        ...
        title={
          <div className="flex items-center gap-2">
            ...
            {isPersonalDataComplete && (
              <span className="fill-green-600 font-bold">
                <CheckIcon />
              </span>
            )}
          </div>
