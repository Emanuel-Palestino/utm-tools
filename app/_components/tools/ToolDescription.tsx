...
export const ToolDescription: FC<ToolDescriptionProps> = ({
  tool,
  onClose,
}) => {
      ...
      >
        ...
        >
          <svg
            ...
            className="w-6 h-6 fill-utm-on-container"
            viewBox="0 0 16 16"
          >
        ...
        >
          ...
          <p className="text-xs md:text-sm">
            ...
            {formatedDate(new Date(`${tool.date} GMT-6`).getTime())}
          </p>
        </motion.div>
