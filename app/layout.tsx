...
export const metadata: Metadata = {
  ...
  description:
    "Documentación de servicio social y estancias profesionales de la UTM. Formatos y plantillas de documentos y otras herramientas Universidad Tecnológica de la Mixteca.",
  keywords: [
    "utm",
    "servicio social",
