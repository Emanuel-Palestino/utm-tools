...
export const Format: FC<{ data: MakeUpExam; date: number }> = ({
  data,
  date,
}) => {
  return (
...
const Section: FC<{ to: string; data: MakeUpExam; date: number }> = ({
  to,
  data,
  date,
}) => {
  return (
    <div>
      ...
      <p className="font-bold mt-2 leading-none text-[14px]">
        En caso de que el alumno no tenga derecho a presentar el examen de
        acuerdo al Reglamento de alumnos de Licenciatura vigente, la
        calificación obtenida en el examen no tendrá validez.
      </p>

      <div className="flex gap-16 justify-center mt-11 text-[14px]">
        <p className="border-black border-t w-56 text-center leading-none">
          FIRMA DEL ALUMNO
        </p>
        <p className="border-black border-t w-56 text-center leading-none">
          DEPTO. DE SERVICIOS ESCOLARES
