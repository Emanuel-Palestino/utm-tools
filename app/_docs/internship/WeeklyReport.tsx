  ...
  return (
    <section className="w-full h-full text-[15px] flex flex-col justify-between">
      <div>
        <div className="flex flex-wrap px-6">
          ...
          <p className="w-full text-center text-[18px]">
            REPORTE PARCIAL DE ACTIVIDADES REALIZADAS
          </p>
        </div>
        ...
        <div className="flex flex-col mt-8 gap-4">
          <div>
            <p className="w-full text-right">
              Formato No. {partialReport.formatNumber}
            </p>
          ...
          <div className="border-black border-[1px] p-1">
            ...
            <div className="flex gap-4">
              <p className="text-left min-w-[180px]">
          ...
          <div className="border-black border-[1px] p-1">
            ...
            <div className="flex gap-4">
              ...
              <p className="font-medium">
                {formatedDate(partialReport.startDate)}{" "}
                <span className="inline-block w-20 text-center font-normal">
                  AL
                </span>{" "}
                {formatedDate(partialReport.endDate)}
              </p>
            </div>
      ...
      <div className="flex justify-around text-center">
        <p className="border-t-[1px] border-black min-w-[170px]">
          Firma del Alumno
        </p>
