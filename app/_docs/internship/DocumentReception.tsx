    ...
    <div>
      <div className="mt-5">
        <table className="w-full table-auto border-collapse border-t border-l border-black text-center">
          ...
          <tbody>
            <tr>
              <td className="border-b border-r border-black p-1" colSpan={2}>
                {person.name}
              </td>
            ...
            <tr className="text-[10px]">
              <td className="border-b border-r border-black p-1">
                Acuse del oficio de presentación por parte de la empresa
                receptora
              </td>
              <td className="border-b border-r border-black p-1">
              ...
              <td className="border-b border-r border-black p-1">
                Reportes parciales de actividades realizadas (En periodos
                máximos de tres semanas para cada reporte)
              </td>
              <td className="border-b border-r border-black p-1">
                Evaluación final
              </td>
