  ...
  return (
    <section className="w-full h-full text-[13px] flex flex-col justify-between">
      <div className="px-4">
        ...
        <div className="flex flex-col gap-2 mt-4">
          <div className="flex gap-2 items-center">
            <p className="text-left w-[180px] font-semibold leading-4">
          ...
          <div className="flex gap-2">
            <p className="text-left w-[180px] font-semibold">
          ...
          <div className="flex gap-2">
            ...
            <p>
              {formatedDate(activity.startDate)}{" "}
              <span className="inline-block w-32 font-semibold text-center">
                AL
              </span>{" "}
              {formatedDate(activity.endDate)}
            </p>
          </div>
        </div>
          ...
          <table className="w-full table-auto border-collapse border-t border-l border-black">
            <thead>
              <tr>
                ...
                <th className="border-b border-r border-black p-2">
                  A CONTINUACIÓN DESCRIBA LAS ACTIVIDADES REALIZADAS EN EL
                  PERIODO SEÑALADO:
                </th>
              </tr>
            </thead>
      ...
      <div className="flex justify-evenly items-end text-[11px]">
        <p className="border-t border-black w-60 text-center">
        ...
        <div className="flex flex-col gap-8 text-center w-60">
          ...
          <p className="border-t border-black">
            FIRMA DEL RESPONSABLE INMEDIATO
          </p>
        </div>
      </div>
    </section>
