  ...
  return (
    <div className="px-2 w-full flex gap-6 items-center">
      <img
        ...
        src={logo.src}
        alt="logo"
        className="flex-shrink-0 basis-[130px]"
      />
      <div
      ...
      >
        <div className="flex">
          ...
          <p
            ...
            style={{
              paddingLeft: landscape ? "40px" : "16px",
              paddingRight: landscape ? "50px" : "16px",
            }}
          >
            COORDINACIÓN DE ESTANCIAS PROFESIONALES, SERVICIO SOCIAL Y VIAJES DE
            PRÁCTICAS ESCOLARES
          </p>
        </div>
