  ...
  return (
    <section className="w-full h-full text-[13px]">
      <p className="text-center text-[14px]">
        COORDINACIÓN DE ESTANCIAS PROFESIONALES, SERVICIO SOCIAL Y VIAJE DE
        PRÁCTICAS ESCOLARES
      </p>
        ...
        <table className="w-full table-auto border-collapse border-t border-l border-black text-center">
          <thead>
            <tr className="text-[11px]">
              <th className="border-b border-r border-black p-1" colSpan={3}>
                NOMBRE
              </th>
              <th className="border-b border-r border-black p-1">MATRÍCULA</th>
              <th className="border-b border-r border-black p-1" colSpan={2}>
          ...
          <tbody>
            <tr>
              <td
                className="border-b border-r border-black p-1 leading-3"
                colSpan={3}
              >{`${person.paternalSurname} ${person.maternalSurname} ${person.name}`}</td>
              ...
              <td
                ...
                colSpan={2}
              >
                {formatedDate(period.startDate)} AL <br />{" "}
                {formatedDate(period.endDate)}
              </td>
              <td className="border-b border-r border-black p-1">
                {student.semester}
              </td>
              <td className="border-b border-r border-black p-1 leading-3">
                {student.career}
              </td>
            </tr>
            <tr>
              <td
                className="border-b border-r border-black text-left p-1 h-16 align-top"
                colSpan={8}
              >
            ...
            <tr className="text-[10px]">
              <td className="border-b border-r border-black p-1 leading-4">
                FORMATO DE SOLICITUD PARA LA PRESTACIÓN DE SERVICIO SOCIAL
              </td>
              <td className="border-b border-r border-black p-1 leading-4">
                CRONOGRAMA DE ACTIVIDADES
              </td>
              <td className="border-b border-r border-black p-1 leading-4">
                ACUSE DE OFICIO DE PRESENTACIÓN
              </td>
              <td className="border-b border-r border-black p-1 leading-4">
                OFICIO DE ACEPTACIÓN EMITIDO POR LA INSTITUCIÓN O DEPENDENCIA
              </td>
              <td className="border-b border-r border-black p-1 leading-4">
                REPORTES MENSUALES DE ACTIVIDADES
              </td>
              <td className="border-b border-r border-black p-1 leading-4">
                EVALUACIÓN FINAL POR PARTE DE LA INSTITUCIÓN O DEPENDENCIA
              </td>
              <td className="border-b border-r border-black p-1 leading-4">
                OFICIO DE TERMINACIÓN EMITIDO POR PARTE DE LA INSTITUCIÓN O
                DEPENDENCIA
              </td>
              <td className="border-b border-r border-black p-1 leading-4">
                INFORME FINAL CON V°B° DE JEFATURA DE CARRERA
              </td>
            </tr>
            <tr>
      ...
      <div className="flex gap-8 mt-6 px-3">
        <div className="flex flex-col justify-between basis-5/12 text-center px-2">
          ...
          <p className="leading-4">
            L.C.E. María Luisa Barragán Ramírez Coordinadora de Vinculación de
            Alumnos y Egresados
          </p>
        </div>
